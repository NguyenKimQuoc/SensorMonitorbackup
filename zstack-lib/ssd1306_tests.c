...
void ssd1306_DisplaySensorFrame()
{  
  ssd1306_SetCursor(2, 16 + 4);
  ssd1306_WriteString("00", Font_16x26, White);
  ...
  ssd1306_SetCursor(2 + 16*2, 16 + 3 + 14);
  ...
  ssd1306_SetCursor(SSD1306_WIDTH/2 + 1 + 8 +16*2, 16 + 3 + 14);
  ssd1306_WriteString(".00", Font_7x10, White);
