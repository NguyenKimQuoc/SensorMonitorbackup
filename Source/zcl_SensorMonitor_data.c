...
const uint8 zclSensorMonitor_ModelId[] = { 9, 'W', 'H', '_', 'S', 'E', 'N', 'S', 'O', 'R'};
const uint8 zclSensorMonitor_DateCode[] = { 8, '2','0','2','2','1','2','1','1' };
const uint8 zclSensorMonitor_PowerSource = POWER_SOURCE_BATTERY;
   ...
   POWER_CFG, 
    {
      ...
      ZCL_DATATYPE_UINT8, 
      ACCESS_CONTROL_READ | ACCESS_REPORTABLE, 
      (void *)&zclBattery_PercentageRemainig
    }
  },
  {
   POWER_CFG, 
    {
      ATTRID_POWER_CFG_BATTERY_VOLTAGE_RAW_ADC, 
      ZCL_DATATYPE_UINT16, 
      ACCESS_CONTROL_READ | ACCESS_REPORTABLE, 
      (void *)&zclBattery_RawAdc
    }
  },
  {
   HUMIDITY,
